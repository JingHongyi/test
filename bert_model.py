...
#             if len(content[1])>=40:
#                 res_ids, res_mask = [], []
#                 token1 = tokenizer(content[1],padding='max_length',max_length=40,truncation=True)
#                 res_ids.append(token1['input_ids'])
#                 res_mask.append(token1['attention_mask'])
#                 token2 = tokenizer(content[1][-40:],padding='max_length',max_length=40,truncation=True)
...
#                 res = []
#                 mask = []
#                 token = tokenizer(content[1],padding='max_length',max_length=40,truncation=True)
...
train_text = one_texts[:2000] + zero_texts[:2000]
